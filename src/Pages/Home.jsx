        ...
        <CenterContainer>
            ...
            <motion.div initial={"hidden"} animate={"show"} variants={variants}>
                <p className="text-sm uppercase tracking-widest muted">
                    <a
                        href="https://nabilridhwan.github.io"
                ...
                >
                    With Similarify, you can discover new songs you'd like based
                    on the songs you already like!
                </motion.p>
            </motion.div>
            ...
            <motion.div animate={control} className="mt-10">
                <Link
            ...
            {/* Footer */}
            <motion.div animate={fromTopAnim} custom={9}>
                <Footer />
            </motion.div>
        </CenterContainer>
    );
