...
const ERRORS = {
    401: {
        ...
        message:
            "Your token expired OR You have cancelled the authentication request.",
    },

    403: {
        title: "You are not verified to use Similarify",
        message:
            "Similarify is currently not for public use. Please contact the admin to get access.",
    },
...
export default function Error() {
    ...
    const error = Object.prototype.hasOwnProperty.call(ERRORS, errorCode)
        ? ERRORS[errorCode]
        : {
              title: "Unknown error",
    ...
    return (
        <Container>
            <div className="text-center my-20">
                <h1 className="font-bold text-5xl my-10">{error.title}</h1>
                ...
                {!Object.prototype.hasOwnProperty.call(ERRORS, errorCode) && (
                    <div className="pt-5">
                        ...
                        <h2 className="font-bold mt-3">Error Source</h2>
                        <p className="dark:text-white/60 text-black/60">
                            {from}
                        </p>
                    </div>
