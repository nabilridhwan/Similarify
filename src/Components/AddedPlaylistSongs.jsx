...
export default function AddedPlaylistSongs({ onClose, onClearAll }) {
    ...
    const [showAddToExistingPlaylist, setShowAddToExistingPlaylist] =
        useState(false);
    ...
    const handleCreatePlaylist = () => {
        ...
        if (pDesc === "") {
            pDesc =
                "This playlist is created by Similarify (https://similarify.netlify.app). Find similar songs to the ones you like!";
        }
            ...
            >
                <div className="md:w-1/2 mx-auto">
                    <h2 className="text-2xl font-bold">
                        {addedPlaylistSongs.length < 2
                            ? `${addedPlaylistSongs.length} song added to the playlist`
                            : `${addedPlaylistSongs.length} songs added to the playlist`}
                    </h2>
                    ...
                    <AnimatePresence>
                        ...
                        >
                            {addedPlaylistSongs.length === 0 && (
                                <h1>Add songs to get started!</h1>
                            )}
                            ...
                            <textarea
                                ...
                                cols="30"
                                rows="3"
                                className="search-box resize-none"
                                onChange={(e) =>
                            ...
                            <button
                                ...
                                className="mt-2 transition btn bg-green-500 block text-white text-center shadow-md w-full disabled-button"
                ...
                <AnimatePresence>
                    {showAddToExistingPlaylist && (
                        <AddToExistingPlaylist
                            ...
                            onClose={() => setShowAddToExistingPlaylist(false)}
                        />
                    )}
                </AnimatePresence>
            </motion.div>
