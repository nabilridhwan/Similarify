...
export default function AdjustParameters({ track, onClose }) {
    ...
    const [parameters, setParameters] = useState([
        ...
        new Parameter(
            "popularity",
            "The higher the value, the more popular the track is.",
            50,
            0,
            100,
            1,
        ...
        new Parameter(
            "danceability",
            "The higher the value, the more danceable the track.",
            0.5,
            0,
            1,
            0.01
        ...
        new Parameter(
            "instrumentalness",
            "The higher the value, the more likely the track is instrumental.",
            0.5,
            0,
            1,
            0.01
        ...
        new Parameter(
            "liveness",
            "The higher the value, the more likely the track is live.",
            0.5,
            0,
            1,
            0.01
        ...
        new Parameter(
            "speechiness",
            "The higher the value, the more likely the track is speech.",
            0.5,
            0,
            1,
            0.01
        ...
        new Parameter(
            "valence",
            "The higher the value, the more positive the track.",
            0.5,
            0,
            1,
            0.01
    ...
    const currentSongParams = addedSongs.find(
    ...
    const handleChange = (e, currentParameter) => {
        ...
        const newObj = {
            ...parameters,
            [currentParameter.name]: currentParameter.getValue(),
        };
    ...
    const handleClickParam = (index) => {
        ...
        if (activeParams.includes(currentParameter.name)) {
            ...
            setActiveParams(
                activeParams.filter((p) => p !== currentParameter.name)
            );
        } else {
            ...
            setActiveParams(
                Array.from(new Set([...activeParams, currentParameter.name]))
            );
        }
    };
    ...
    const handleClickSave = () => {
        ...
        console.log(
            `New parameters for ${track.name}: ${JSON.stringify(finalObject)}`
        );
        ...
        >
            <ModalWindow>
                <ModalHeader
                    ...
                    subtitle="Adjust specific parameters relative to this song to get better recommendations."
                />
                                    ...
                                    >
                                                ...
                                                <motion.h1
                                                    ...
                                                    className={`${
                                                        !activeParams.includes(
                                                            ...
                                                            ? "muted"
                                                            : "font-bold"
                                                    } capitalize  w-fit cursor-pointer`}
                                                >
                                                    {currentParameter.name}
                                                </motion.h1>
                                        ...
                                        <AnimatePresence>
                                            {activeParams.includes(
                                                ...
                                                >
                                                    <motion.p className="my-2 text-xs muted">
                                                        {
                ...
                <motion.button
                    ...
                    className="btn  bg-green-500 text-white w-full mb-2"
                >
                    Save
                </motion.button>
