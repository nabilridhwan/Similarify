            ...
            if (Object.prototype.hasOwnProperty.call(playlists, "items")) {
                let n = playlists.items.map((playlist) => {
                    ...
                    if (
                        ...
                        playlist.images[0].hasOwnProperty("url")
                    ) {
    ...
    const handleClickPlaylist = async (playlist) => {
        try {
            ...
            let t_uris = t
                .map((t) => {
                    if (
                        Object.prototype.hasOwnProperty.call(t, "track") &&
                        t.track
                    ) {
                        return t.track.uri;
                    }
            ...
            if (final.length > 0) {
                ...
                setError(
                    "No new songs to add. All songs already exists in the playlist."
                );
                setMessage("");
            }
        } catch (error) {
        ...
        >
            <ModalWindow>
                <ModalHeader
                    ...
                    subtitle="Select a playlist to add your songs to"
                />
                <div className="my-2">
                    {error && (
                ...
                <motion.button
                    ...
                    whileTap={{ scale: 0.9 }}
                    onClick={onClose}
                    className="btn  bg-red-500 text-white w-full mt-3"
                >
                    Cancel
                </motion.button>
            </ModalWindow>
